...
# m1.2way <- MCMCglmm(attackers ~ species-1 + species:preysize_z+ preysize_z*timepoint_z + species:timepoint_z,
#                     random = ~ us(1+timepoint_z):trial,
#                     data   = mydat,
#                     family = "poisson",
#                     prior  = MyPrior,
...
save.image(paste(OUTPATH,"/", "N attackers WITH outliers.RData", sep = ""))
